...
rewrite replacements that use unnamed PCRE captures.`,
	"cve-2026-41940-cpanel-whm-auth-bypass": `cPanel & WHM / WP Squared auth bypass (CVE-2026-41940).
Do not run unauthenticated auth-bypass probes on production unless explicitly authorized.
Verify on the host: /usr/local/cpanel/cpanel -V
Patch immediately to the fixed release for the branch, then restrict public access to
management ports 2082/2083/2086/2087/2095/2096 until patched.`,
